        ...
        if (shot.isVisible()) {
            ...
            if (y < 0) {
                ...
                if (enemy.isVisible() && shot.isVisible()) {
                    ...
                    /*if (shotX + 64 >= (enemyX) && shotX + 64 <= (enemyX + ENEMY_WIDTH) && shotY>= (enemyY) && shotY <= (enemyY + ENEMY_HEIGHT)) {
                        shot.die();
                        elives.enemylives -=1;
                        elives.initELives();
                    }*/
    ...
    public void enemyanimationcycle() {
        ...
        if (eshot.isVisible()) {
            ...
            if (enemy.isVisible() && eshot.isVisible()) {
                ...
                /*if (eshotX + 48 >= (playerX) && eshotX + 48 <= (playerX + PLAYER_WIDTH) && eshotY >= (playerY) && eshotY <= (playerY + PLAYER_HEIGHT)) {
                    eshot.die();
                    plives.playerlives -=1;
                    plives.initPLives();
                }*/
